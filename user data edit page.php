...
$sql = "SELECT * FROM visitor_table where id = ?";
$q = $pdo->prepare($sql);
$q->execute(array($id));
...
<head>
    ...
    <title>Edit Visitor Data.</title>

</head>

<body>

    <h2 align="center">Visitor Data Edit Page</h2>
        ...
        <div class="center" style="margin: 0 auto; width:495px; border-style: solid; border-color: #f2f2f2;">
            ...
            <form class="form-horizontal" action="user data edit tb.php?id=<?php echo $id ?>" method="post">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select name="location">
                            ...
                            <option value="ENTC">ENTC faculty</option>
                            <option value="Archi">Archi faculty</option>
                            <option value="TMLE">TMLE faculty</option>
                            <option value="Mechanical">Mechanical faculty</option>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input name="purpose" type="text" placeholder="" value="<?php echo $data['purpose']; ?>" required>
                    </div>
                </div>
